...
export default {
    ...
    messages: {
        ...
        confirmed:(field)=> `${field} لا يماثل كلمة المرور الاصلية`,
        ...
        length:(field,[length])=> `حقل ${field} يجب أن يكون ${length} خانات`,
